...
class EmployeesManager{
        ...
        private function getConnect(){
            if(is_null($this->connect)){
                $this->connect =  mysqli_connect('localhost','REDA','Halhoulidu7373','realisation');
            }
    ...
    public function insertEmployees($employee){
        ...
        $insertDB = "INSERT INTO éemployees(first_name,last_name,age,department,occupation,salary,img) VALUES('$firstName','$lastName','$age','$department','$occupation','$salary','$image')";
    ...
    public function getAllEmployees(){
        ...
        $sqlGetData = "SELECT ID, first_name,last_name, age,department,occupation,salary,img FROM éemployees";
    ...
    public function modifyEmployee($employee, $id){
        ...
        $salary = $employee->getSalary();
        $image = $employee->getImage();
        $updateDB = "UPDATE éemployees SET first_name = '$first_Name',  last_name = '$last_Name', age = '$age', department = '$department', occupation = '$occupation', salary = '$salary', img = '$image'
        WHERE ID = $id";
    ...
    public function searchByInput($searchInput){
        ...
        $selectedRow = "SELECT * FROM éemployees WHERE first_name = '$searchInput' OR last_name = '$searchInput' OR department = '$searchInput'";
